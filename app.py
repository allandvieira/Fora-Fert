...
def get_recommendation():
    ...
    try:
        ...
        data_facts = [soil_type, soil_ph, organic_matter_content_in_the_soil, content_p, content_k, content_ca, content_mg, base_saturation, aluminum_saturation, forage, annual_or_perennial_culture, first_planting_of_the_crop, plantation_use_type]

        formatted_result = wrapper.format_rules_for_clips(data_facts)
